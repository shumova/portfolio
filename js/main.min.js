...
/* harmony import */ var _modules_init_page_intro__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-page-intro */ "./js/modules/init-page-intro.js");
/* harmony import */ var _modules_init_header_height__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-header-height */ "./js/modules/init-header-height.js");
/* harmony import */ var _modules_init_main_nav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-main-nav */ "./js/modules/init-main-nav.js");
/* harmony import */ var _utils_static_vh__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/static-vh */ "./js/utils/static-vh.js");
...
/* harmony import */ var _modules_animation_scroll_animation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/animation/scroll-animation */ "./js/modules/animation/scroll-animation.js");
/* harmony import */ var _modules_init_preloader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-preloader */ "./js/modules/init-preloader.js");
/* harmony import */ var _utils_ios_input_scale_fix__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/ios-input-scale-fix */ "./js/utils/ios-input-scale-fix.js");
/* harmony import */ var _modules_init_exclude_locomotive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-exclude-locomotive */ "./js/modules/init-exclude-locomotive.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_utils_static_vh__WEBPACK_IMPORTED_MODULE_4__["staticVh"])();
  Object(_utils_ios_input_scale_fix__WEBPACK_IMPORTED_MODULE_8__["iosInputScaleFix"])();
  ...
  // initLocoScroll();
  // initLocoHeader();
  Object(_modules_init_preloader__WEBPACK_IMPORTED_MODULE_7__["initPreloader"])();
  Object(_modules_init_page_intro__WEBPACK_IMPORTED_MODULE_1__["initPageIntro"])();
  Object(_modules_init_header_height__WEBPACK_IMPORTED_MODULE_2__["initHeaderHeight"])();
  Object(_modules_init_main_nav__WEBPACK_IMPORTED_MODULE_3__["initMainNav"])();
  Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_5__["initAccordions"])();
  Object(_modules_animation_scroll_animation__WEBPACK_IMPORTED_MODULE_6__["initScrollAnimation"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', () => {
    Object(_modules_init_exclude_locomotive__WEBPACK_IMPORTED_MODULE_9__["initExcludeLocomotive"])();
  });
});
...
/***/ "./js/modules/animation/scroll-animation.js":
/*!**************************************************!*\
  !*** ./js/modules/animation/scroll-animation.js ***!
  \**************************************************/
/*! exports provided: initScrollAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./js/modules/init-exclude-locomotive.js":
/*!***********************************************!*\
  !*** ./js/modules/init-exclude-locomotive.js ***!
  \***********************************************/
/*! exports provided: initExcludeLocomotive */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initExcludeLocomotive", function() { return initExcludeLocomotive; });
/* harmony import */ var _locomotive_scroll_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./locomotive-scroll/index */ "./js/modules/locomotive-scroll/index.js");
...
const onMouseOver = evt => {
  if (evt.target.closest('[data-exclude-locomotive]')) {
    _locomotive_scroll_index__WEBPACK_IMPORTED_MODULE_0__["locoScroll"].stop();
  }
};
const onMouseOut = evt => {
  if (evt.target.closest('[data-exclude-locomotive]')) {
    _locomotive_scroll_index__WEBPACK_IMPORTED_MODULE_0__["locoScroll"].start();
  }
};
...
/***/ "./js/modules/init-header-height.js":
/*!******************************************!*\
  !*** ./js/modules/init-header-height.js ***!
  \******************************************/
/*! exports provided: initHeaderHeight */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHeaderHeight", function() { return initHeaderHeight; });
...
const focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
const header = document.querySelector('.header');
...
const openMenu = () => {
  if (!header.classList.contains('is-opened')) {
    ...
    Object(_vendor_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["disablePageScroll"])(mainNav);
  }
};
const closeMenu = () => {
  if (header.classList.contains('is-opened')) {
    ...
    focusLock.unlock();
    Object(_vendor_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["enablePageScroll"])(mainNav);
  }
};
...
/***/ "./js/modules/init-page-intro.js":
/*!***************************************!*\
  !*** ./js/modules/init-page-intro.js ***!
  \***************************************/
/*! exports provided: initPageIntro */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPageIntro", function() { return initPageIntro; });
...
const initPageIntro = () => {
  ...
  const initPageIntroSlider = () => new window.Swiper(pageIntroSlider, {
    ...
    a11y: _constants__WEBPACK_IMPORTED_MODULE_0__["a11y"],
    pagination: {
...
/***/ "./js/modules/locomotive-scroll/index.js":
/*!***********************************************!*\
  !*** ./js/modules/locomotive-scroll/index.js ***!
  \***********************************************/
/*! exports provided: initLocoScroll, locoScroll */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initLocoScroll", function() { return initLocoScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "locoScroll", function() { return locoScroll; });
/* harmony import */ var _loco_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loco-scroll */ "./js/modules/locomotive-scroll/loco-scroll.js");
...
const initLocoScroll = () => {
  ...
  const locoScrollEntity = new _loco_scroll__WEBPACK_IMPORTED_MODULE_0__["LocoScroll"](container);
...
/***/ "./js/modules/locomotive-scroll/loco-scroll.js":
/*!*****************************************************!*\
  !*** ./js/modules/locomotive-scroll/loco-scroll.js ***!
  \*****************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocoScroll", function() { return LocoScroll; });
/* harmony import */ var _utils_throttle_debounce__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/throttle-debounce */ "./js/utils/throttle-debounce.js");
/* harmony import */ var _vendor_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../vendor/locomotive-scroll */ "./js/vendor/locomotive-scroll.js");
/* harmony import */ var _vendor_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1__);
...
class LocoScroll {
  ...
  init() {
    this.scroll = new _vendor_locomotive_scroll__WEBPACK_IMPORTED_MODULE_1___default.a({
      el: this.el,
      smooth: true,
      getDirection: true,
      getSpeed: true
    });
    window.addEventListener('resize', Object(_utils_throttle_debounce__WEBPACK_IMPORTED_MODULE_0__["debounce"])(500, () => {
      this.scroll.update();
    }));
  }
}
...
const SELECTORS = ['a[href]', 'area[href]', 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', 'select:not([disabled]):not([aria-hidden])', 'textarea:not([disabled]):not([aria-hidden])', 'button:not([disabled]):not([aria-hidden])', 'iframe', 'object', 'embed', '[contenteditable]', '[tabindex]:not([tabindex^="-"])'];
class FocusLock {
  constructor() {
...
/*!*****************************************!*\
  !*** ./js/utils/ios-input-scale-fix.js ***!
  \*****************************************/
/*! exports provided: iosInputScaleFix */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "iosInputScaleFix", function() { return iosInputScaleFix; });
...
/***/ "./js/utils/static-vh.js":
/*!*******************************!*\
  !*** ./js/utils/static-vh.js ***!
  \*******************************/
/*! exports provided: staticVh */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "staticVh", function() { return staticVh; });
class ScreenHeight {
  constructor() {
    this.document = document.documentElement;
...
/* WEBPACK VAR INJECTION */(function(global) {/* locomotive-scroll v4.1.3 | MIT License | https://github.com/locomotivemtl/locomotive-scroll */
